...
function Home() {
  ...
  const handleCreateSummary = async (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault();
          ...
          <div>
            ...
            {saveSummaryAllowed && (
              <form onSubmit={handleSaveSummary}>
                <button className="rounded-md bg-yellow-50 text-black p-1" type="submit">Save Summary</button>
              </form>
            )
            }
